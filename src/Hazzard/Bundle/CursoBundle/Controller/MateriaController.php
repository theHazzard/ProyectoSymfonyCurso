...
use Hazzard\Bundle\CursoBundle\Entity\Materia;
use Hazzard\Bundle\CursoBundle\Form\MateriaType;
...
class MateriaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HazzardCursoBundle:Materia')->findAll();
     ...
     * @Method("POST")
     * @Template("HazzardCursoBundle:Materia:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HazzardCursoBundle:Materia')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HazzardCursoBundle:Materia:edit.html.twig")
     */
