...
use Hazzard\Bundle\CursoBundle\Entity\Curso;
use Hazzard\Bundle\CursoBundle\Form\CursoType;
...
class CursoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HazzardCursoBundle:Curso')->findAll();
     ...
     * @Method("POST")
     * @Template("HazzardCursoBundle:Curso:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HazzardCursoBundle:Curso')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("HazzardCursoBundle:Curso:edit.html.twig")
     */
